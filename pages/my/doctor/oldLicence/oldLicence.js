...
Page({
  ...
  data: {
    licenceId: '',
    licenceImg: '/image/oldLicence.png', // 默认身份证照片正面
    licenceInfoImg: '/image/oldLicenceBack.png', // 默认身份证照片背面
    version: 'old',
    curVersion: '',
    picture: '',
    photo: ''
        ...
        if (that.data.curVersion == 'old') {
          ...
          wx.getStorage({
            ...
            success: function (res) {
              if (res.data) {
                that.setData({
                  licenceImg: app.globalData.config.sinaHost + '/picture/' + res.data,
                  photo: res.data
                });
              }
            }
